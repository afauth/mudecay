...
#         myprint(f'Try number {saved_csv + 1}. Total of {acquired_samples}.')

#         waveform = Acquisition_Waveform(
#             oscilloscope=scope,
#             necessarySamples=min(100, cfg_scope.necessarySamples),
#             height=0,
#             min_peaks=cfg_scope.min_peaks, 
#             oscilloscope_resolution=cfg_scope.scopeResolution,
#             numberBins=cfg_scope.numberBins,
...
# Waveforms_df.to_csv(f'{folder_name}/{time_start}_{Waveforms_df.shape[1]}-events_{cfg_scope.min_peaks}-peaks.csv')
